...
public class SHA512 {
    ...
    protected static void hashBlock() {
        ...
        short tmpOff;
        AN1 = working[H0];
        AN2 = working[(short) (H0 + 1)];
        AN3 = working[(short) (H0 + 2)];
        AN4 = working[(short) (H0 + 3)];
        BN1 = working[H1];
        BN2 = working[(short) (H1 + 1)];
        BN3 = working[(short) (H1 + 2)];
        BN4 = working[(short) (H1 + 3)];
        CN1 = working[H2];
        CN2 = working[(short) (H2 + 1)];
        CN3 = working[(short) (H2 + 2)];
        CN4 = working[(short) (H2 + 3)];
        DN1 = working[H3];
        DN2 = working[(short) (H3 + 1)];
        DN3 = working[(short) (H3 + 2)];
        DN4 = working[(short) (H3 + 3)];
        EN1 = working[H4];
        EN2 = working[(short) (H4 + 1)];
        EN3 = working[(short) (H4 + 2)];
        EN4 = working[(short) (H4 + 3)];
        FN1 = working[H5];
        FN2 = working[(short) (H5 + 1)];
        FN3 = working[(short) (H5 + 2)];
        FN4 = working[(short) (H5 + 3)];
        GN1 = working[H6];
        GN2 = working[(short) (H6 + 1)];
        GN3 = working[(short) (H6 + 2)];
        GN4 = working[(short) (H6 + 3)];
        HN1 = working[H7];
        HN2 = working[(short) (H7 + 1)];
        HN3 = working[(short) (H7 + 2)];
        HN4 = working[(short) (H7 + 3)];
        for (byte j = 0; j < 80; j++) {
            if (j >= 16) {
                tmpOff = (short) (4 * (short) ((j - 2) & 0xF));
                T2N1 = blk[tmpOff];
            ...
            AN3 = T1N3;
            AN4 = T1N4;
            addxl = (short) ((AN4 & 0xFF) + (T2N4 & 0xFF));
            addxh = (short) (((AN4 >>> 8) & 0xFF) + ((T2N4 >>> 8) & 0xFF) + (short) (addxl >>> 8));
            addc = (short) (addxh >>> 8);
            AN4 = (short) ((addxh << 8) | (addxl & 0xFF));
            addxl = (short) ((AN3 & 0xFF) + (T2N3 & 0xFF) + addc);
            addxh = (short) (((AN3 >>> 8) & 0xFF) + ((T2N3 >>> 8) & 0xFF) + (short) (addxl >>> 8));
            addc = (short) (addxh >>> 8);
            AN3 = (short) ((addxh << 8) | (addxl & 0xFF));
            addxl = (short) ((AN2 & 0xFF) + (T2N2 & 0xFF) + addc);
            addxh = (short) (((AN2 >>> 8) & 0xFF) + ((T2N2 >>> 8) & 0xFF) + (short) (addxl >>> 8));
            addc = (short) (addxh >>> 8);
            AN2 = (short) ((addxh << 8) | (addxl & 0xFF));
            addxl = (short) ((AN1 & 0xFF) + (T2N1 & 0xFF) + addc);
            addxh = (short) (((AN1 >>> 8) & 0xFF) + ((T2N1 >>> 8) & 0xFF) + (short) (addxl >>> 8));
            AN1 = (short) ((addxh << 8) | (addxl & 0xFF));
            addxl = (short) ((EN4 & 0xFF) + (T1N4 & 0xFF));
            addxh = (short) (((EN4 >>> 8) & 0xFF) + ((T1N4 >>> 8) & 0xFF) + (short) (addxl >>> 8));
            addc = (short) (addxh >>> 8);
            EN4 = (short) ((addxh << 8) | (addxl & 0xFF));
            addxl = (short) ((EN3 & 0xFF) + (T1N3 & 0xFF) + addc);
            addxh = (short) (((EN3 >>> 8) & 0xFF) + ((T1N3 >>> 8) & 0xFF) + (short) (addxl >>> 8));
            addc = (short) (addxh >>> 8);
            EN3 = (short) ((addxh << 8) | (addxl & 0xFF));
            addxl = (short) ((EN2 & 0xFF) + (T1N2 & 0xFF) + addc);
            addxh = (short) (((EN2 >>> 8) & 0xFF) + ((T1N2 >>> 8) & 0xFF) + (short) (addxl >>> 8));
            addc = (short) (addxh >>> 8);
            EN2 = (short) ((addxh << 8) | (addxl & 0xFF));
            addxl = (short) ((EN1 & 0xFF) + (T1N1 & 0xFF) + addc);
            addxh = (short) (((EN1 >>> 8) & 0xFF) + ((T1N1 >>> 8) & 0xFF) + (short) (addxl >>> 8));
            EN1 = (short) ((addxh << 8) | (addxl & 0xFF));
        }
        ...
        adda = working[(short) (H1 + 3)];
        addxl = (short) ((adda & 0xFF) + (BN4 & 0xFF));
        addxh = (short) (((adda >>> 8) & 0xFF) + ((BN4 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H1 + 3)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H1 + 2)];
        addxl = (short) ((adda & 0xFF) + (BN3 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((BN3 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H1 + 2)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H1 + 1)];
        addxl = (short) ((adda & 0xFF) + (BN2 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((BN2 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H1 + 1)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[H1];
        addxl = (short) ((adda & 0xFF) + (BN1 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((BN1 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        working[H1] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H2 + 3)];
        addxl = (short) ((adda & 0xFF) + (CN4 & 0xFF));
        addxh = (short) (((adda >>> 8) & 0xFF) + ((CN4 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H2 + 3)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H2 + 2)];
        addxl = (short) ((adda & 0xFF) + (CN3 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((CN3 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H2 + 2)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H2 + 1)];
        addxl = (short) ((adda & 0xFF) + (CN2 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((CN2 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H2 + 1)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[H2];
        addxl = (short) ((adda & 0xFF) + (CN1 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((CN1 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        working[H2] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H3 + 3)];
        addxl = (short) ((adda & 0xFF) + (DN4 & 0xFF));
        addxh = (short) (((adda >>> 8) & 0xFF) + ((DN4 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H3 + 3)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H3 + 2)];
        addxl = (short) ((adda & 0xFF) + (DN3 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((DN3 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H3 + 2)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H3 + 1)];
        addxl = (short) ((adda & 0xFF) + (DN2 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((DN2 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H3 + 1)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[H3];
        addxl = (short) ((adda & 0xFF) + (DN1 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((DN1 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        working[H3] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H4 + 3)];
        addxl = (short) ((adda & 0xFF) + (EN4 & 0xFF));
        addxh = (short) (((adda >>> 8) & 0xFF) + ((EN4 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H4 + 3)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H4 + 2)];
        addxl = (short) ((adda & 0xFF) + (EN3 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((EN3 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H4 + 2)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H4 + 1)];
        addxl = (short) ((adda & 0xFF) + (EN2 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((EN2 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H4 + 1)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[H4];
        addxl = (short) ((adda & 0xFF) + (EN1 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((EN1 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        working[H4] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H5 + 3)];
        addxl = (short) ((adda & 0xFF) + (FN4 & 0xFF));
        addxh = (short) (((adda >>> 8) & 0xFF) + ((FN4 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H5 + 3)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H5 + 2)];
        addxl = (short) ((adda & 0xFF) + (FN3 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((FN3 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H5 + 2)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H5 + 1)];
        addxl = (short) ((adda & 0xFF) + (FN2 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((FN2 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H5 + 1)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[H5];
        addxl = (short) ((adda & 0xFF) + (FN1 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((FN1 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        working[H5] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H6 + 3)];
        addxl = (short) ((adda & 0xFF) + (GN4 & 0xFF));
        addxh = (short) (((adda >>> 8) & 0xFF) + ((GN4 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H6 + 3)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H6 + 2)];
        addxl = (short) ((adda & 0xFF) + (GN3 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((GN3 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H6 + 2)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H6 + 1)];
        addxl = (short) ((adda & 0xFF) + (GN2 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((GN2 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H6 + 1)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[H6];
        addxl = (short) ((adda & 0xFF) + (GN1 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((GN1 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        working[H6] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H7 + 3)];
        addxl = (short) ((adda & 0xFF) + (HN4 & 0xFF));
        addxh = (short) (((adda >>> 8) & 0xFF) + ((HN4 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H7 + 3)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H7 + 2)];
        addxl = (short) ((adda & 0xFF) + (HN3 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((HN3 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H7 + 2)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[(short) (H7 + 1)];
        addxl = (short) ((adda & 0xFF) + (HN2 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((HN2 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        addc = (short) (addxh >>> 8);
        working[(short) (H7 + 1)] = (short) ((addxh << 8) | (addxl & 0xFF));
        adda = working[H7];
        addxl = (short) ((adda & 0xFF) + (HN1 & 0xFF) + addc);
        addxh = (short) (((adda >>> 8) & 0xFF) + ((HN1 >>> 8) & 0xFF) + (short) (addxl >>> 8));
        working[H7] = (short) ((addxh << 8) | (addxl & 0xFF));
    }
}
